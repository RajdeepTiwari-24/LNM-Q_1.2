          ...
          <footer className="mt-10 mb-0 w-full text-center flex flex-col space-y-10">
            ...
            <div className="grid grid-cols-7 space-x-4">
              <a
                ...
                target="_blank"
              >
                <div className=" bg-[#3a3939] flex flex-row space-x-2 p-4 rounded">
                  {" "}
                  <img
            ...
            <div className="grid grid-cols-6 p-8 bg-[#3a3939] text-neutral-50/[0.6] text-xs">
              <div className="col-start-1 col-span-4 text-start space-y-5 ml-8">
                <img src={logo} className="w-16" alt="" />
                <p>
                  To inspire powerful conversations among college members so
                  together we can make our college a better place.
                </p>
              </div>
